...
/**
 * This class is an [AbstractConnectionTask] which handles sending data through a IP connection.
 *
 ...
 */
class SocketSendTask(connectionInterface: SocketConnectionInterface)
